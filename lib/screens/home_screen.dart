...
//   final GlobalKey technoKey = GlobalKey();

//   void scrollToSection(GlobalKey key) {
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       final context = key.currentContext;
//       if (context != null) {
//         print("Scrolling to section with key: $key");
...
//       controller: _scrollController,
//       slivers: <Widget>[
//         SliverAppBarComponent(scrollToAboutSection: () => scrollToSection(aboutKey)),
//         SliverToBoxAdapter(
//           child: ListView(
//             controller: _scrollController,
//             cacheExtent: 2000, // Pré-rendre les widgets hors de l'écran
//             shrinkWrap: true,
//             children: <Widget>[
//               Container(
//                 key: aboutKey,
//                 height: 400,
//                 color: Colors.red,
//                 child: Center(child: Text("À propos de moi", style: TextStyle(color: Colors.white))),
//               ),
//               Container(
//                 key: projectsKey,
//                 height: 400,
//                 color: Colors.green,
//                 child: Center(child: Text("Projets", style: TextStyle(color: Colors.white))),
//               ),
//               Container(
//                 key: skillsKey,
//                 height: 400,
//                 color: Colors.blue,
//                 child: Center(child: Text("Compétences", style: TextStyle(color: Colors.white))),
//               ),
//               Container(
//                 key: technoKey,
//                 height: 400,
//                 color: Colors.purple,
//                 child: Center(child: Text("Technologies", style: TextStyle(color: Colors.white))),
//               ),
//             ],
//           ),
//         ),
...
//           scrollToAboutSection: () => scrollToSection(aboutKey)), 
//           SliverList( 
...
//               Container( 
//                 key: technoKey, 
//                 height: 400, color: Colors.purple, 
//                 child: Center(
//                   child: Text(
//                     "Technologies", 
//                     style: TextStyle(color: Colors.white)
